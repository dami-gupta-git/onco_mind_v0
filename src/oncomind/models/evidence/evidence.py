...
from oncomind.config.variant_classes import load_variant_classes
...
class EvidenceForLLM(VariantAnnotations):
    ...
    def get_clinical_trial_summary(self) -> str:
        ...
        if variant_specific:
            ...
            lines.append("  *** VARIANT-SPECIFIC TRIALS ***")
    ...
    def is_vus_in_known_cancer_gene(self) -> bool:
        ...
        from oncomind.api.oncokb import is_known_cancer_gene_sync, FALLBACK_CANCER_GENES
        ...
        if tumor_type and self.fda_approvals:
            ...
            if variant_specific_approvals:
                if later_line_approvals and not first_line_approvals:
                    ...
                    lines.append("")
                    lines.append(f"FDA FIRST-LINE APPROVAL FOR THIS VARIANT: {', '.join(first_line_approvals)}")
        ...
        if self.cgi_biomarkers:
            ...
            if approved:
                ...
                if resistance_approved:
                    ...
                    lines.append("  → This variant causes RESISTANCE to the above drug(s).")
                    lines.append("")

...
python -m oncomind.tools.normalize_variant BRAF V600E --format json   # Default
python -m oncomind.tools.normalize_variant BRAF V600E --format table  # Human-readable
python -m oncomind.tools.normalize_variant BRAF V600E --format tsv    # Tab-separated
...
python -m oncomind.tools.normalize_variant EGFR L858R --quiet
```
...
**Table output:**
```bash
$ python -m oncomind.tools.normalize_variant BRAF p.V600E --format table
============================================================
Gene:             BRAF
Original:         p.V600E
Normalized:       V600E
...
```bash
$ echo -e "BRAF,V600E\nEGFR,L858R\nKRAS,G12C\nALK,fusion" | python -m oncomind.tools.normalize_variant --stdin --format tsv

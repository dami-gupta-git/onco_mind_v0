...
def assert_valid_association(assoc):
    ...
    assert isinstance(assoc.source, str) and assoc.source, "source must be non-empty string"
    assert assoc.source.lower() not in ("civic", "molecularmatch"), "filtered sources should not appear"
...
class TestVICCBRAFV600E:
    ...
    async def test_returns_associations_with_drugs(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("BRAF", "V600E", max_results=200)
    ...
    async def test_melanoma_tumor_filter(self):
        ...
        async with VICCClient() as client:
            ...
            assert len(associations) > 0, "BRAF V600E with melanoma filter should return associations"
...
class TestVICCEGFRL858R:
    ...
    async def test_returns_associations_with_evidence_levels(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("EGFR", "L858R", max_results=200)
            assert len(associations) >= 1, "EGFR L858R should have at least 1 association"
...
class TestVICCEGFRT790M:
    ...
    async def test_has_resistance_associations(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("EGFR", "T790M", max_results=200)
            ...
            assert len(resistance_assocs) > 0, "EGFR T790M should have resistance associations"
...
class TestVICCKRASG12C:
    ...
    async def test_returns_associations_with_drugs(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("KRAS", "G12C", max_results=200)
...
class TestVICCALKFusion:
    ...
    async def test_returns_associations(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("ALK", "Fusion", max_results=200)
            assert len(associations) >= 1, "ALK Fusion should have at least 1 association"
    ...
    async def test_has_sensitivity_associations(self):
        ...
        async with VICCClient() as client:
            ...
            sensitivity_assocs = [a for a in associations if a.is_sensitivity()]
            assert len(sensitivity_assocs) > 0, "ALK Fusion should have sensitivity associations"
...
class TestVICCPIK3CAH1047R:
    ...
    async def test_returns_associations_with_evidence(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("ALK", "F1174L", max_results=200)
            assert len(associations) >= 1, "ALK F1174L should have at least 1 association"
...
class TestVICCERBB2S310F:
    ...
    async def test_to_dict_keys(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("ERBB2", "S310F", max_results=200)
...
class TestVICCRETFusion:
    ...
    async def test_get_oncokb_level(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("RET", "Fusion", max_results=200)
...
class TestVICCMETAmplification:
    ...
    async def test_methods_work(self):
        ...
        async with VICCClient() as client:
            associations = await client.fetch_associations("MET", "amplification", max_results=200)

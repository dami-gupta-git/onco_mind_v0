...
class TestIsVariantCovered:
    ...
    def test_gene_level_covers_any_variant(self):
        ...
        assert is_variant_covered("E17K", specificity) is True
        assert is_variant_covered("V600E", specificity) is True
        assert is_variant_covered("G12C", specificity) is True
    ...
    def test_variant_level_exact_match(self):
        ...
        assert is_variant_covered("G12C", specificity) is True
        assert is_variant_covered("G12D", specificity) is False
        assert is_variant_covered("G12V", specificity) is False
    ...
    def test_codon_level_covers_same_codon(self):
        ...
        assert is_variant_covered("V600E", specificity) is True
        assert is_variant_covered("V600K", specificity) is True
        assert is_variant_covered("V600R", specificity) is True
        assert is_variant_covered("V601E", specificity) is False
    ...
    def test_codon_level_different_codon(self):
        ...
        assert is_variant_covered("G12C", specificity) is True
        assert is_variant_covered("G12D", specificity) is True
        assert is_variant_covered("G13D", specificity) is False
    ...
    def test_exon_level_returns_false(self):
        ...
        assert is_variant_covered("L858R", specificity) is False
    ...
    def test_real_scenario_egfr_t790m_variant_level(self):
        ...
        assert is_variant_covered("T790M", specificity) is True
        assert is_variant_covered("L858R", specificity) is False
    ...
    def test_real_scenario_braf_v600_codon_level(self):
        ...
        assert is_variant_covered("V600E", specificity) is True
        assert is_variant_covered("V600K", specificity) is True
        assert is_variant_covered("K601E", specificity) is False
